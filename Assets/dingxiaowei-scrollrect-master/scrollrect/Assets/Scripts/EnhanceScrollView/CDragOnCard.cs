...
public class CDragOnCard : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	...
	public System.Action<DragPosition> EndDragCallBack = null;
	public System.Action OnDragCallBack = null;
	...
	public void OnBeginDrag(PointerEventData eventData)
	{
		...
		{
            Debug.LogError(touchDeltaPosition.x);
	...
	public void OnEndDrag(PointerEventData eventData)
	{
		...
		if (EndDragCallBack != null)
			EndDragCallBack(m_dragPosition);
	}
